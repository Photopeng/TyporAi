export const RPC_METHODS = [
  ...
  'chat.createRuntime', 'chat.ensureReady', 'chat.startTurn', 'chat.steer', 'chat.cancelTurn', 'chat.rewind', 'chat.resetSession', 'chat.getCommands', 'chat.reloadMcp', 'chat.disposeRuntime', 'chat.getSubagentToolCalls', 'chat.getSubagentFinalResult',
