/**
 * TyporAi - Editor Context Utilities
 *
...
/**
 * Gets the CodeMirror EditorView from an Typora Editor.
 * Typora's Editor type doesn't expose the internal `.cm` property.
 */
export function getEditorView(editor: TyporaEditor): EditorView | undefined {
  return editor.cm;
}
