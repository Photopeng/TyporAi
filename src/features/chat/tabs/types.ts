...
/**
 * Minimal interface for the TyporAiView methods used by TabManager and Tab.
 * Extends Component for Typora integration (event handling, cleanup).
 * Avoids circular dependency by not importing TyporAiView directly.
 */
...
export interface TabUIComponents {
  ...
  cursorFlowToggle: CursorFlowToggle | null;
...
export interface TabData {
  ...
  runtimeFactory?: (options: CreateChatRuntimeOptions) => ChatRuntime;
  providerServiceFactory?: ProviderServiceFactory;
  processTransport?: ProcessTransportFactory;
  commandRegistry?: CommandRegistry;
  documentSnapshot?: () => TyporaDocumentSnapshot | null;
