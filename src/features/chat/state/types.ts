...
export interface ChatStateData {
  ...
  /**
   * External context paths currently bound to this tab's runtime.
   * Mirrored from the chat runtime so the file context manager can read
   * the latest paths even before the runtime finishes restarting.
   */
  currentExternalContextPaths: string[];
}
