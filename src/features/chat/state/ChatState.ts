...
export class ChatState {
  ...
  // ============================================
  // External context paths (mirrored from runtime)
  // ============================================

  get currentExternalContextPaths(): string[] {
    return this.state.currentExternalContextPaths;
  }

  setCurrentExternalContextPaths(paths: string[]): void {
    this.state.currentExternalContextPaths = Array.isArray(paths)
      ? [...paths]
      : [];
  }
