  ...
  children: [
    {
      tag: 'g',
      attributes: {
        class: 'typorai-provider-icon-variant typorai-provider-icon-variant--light',
    ...
    },
    {
      tag: 'g',
      attributes: {
        class: 'typorai-provider-icon-variant typorai-provider-icon-variant--dark',
        transform: 'translate(30 0)',
      },
      children: [
...
export function createProviderIconSvg(
  ...
  svg.classList.add('typorai-provider-icon');
