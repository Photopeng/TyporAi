...
| D9 files, images and inline edit | Hash-protected file service, backups/restore, blob upload and private attachment context | Files and blob boundary implemented; Codex maps staged attachments to `localImage` and OpenCode to ACP image blocks; Claude semantics and full inline-edit acceptance remain open |
