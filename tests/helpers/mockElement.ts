...
const CLASS_DISPLAY: Record<string, string> = {
  'typorai-browser-selection-indicator': 'block',
  'typorai-canvas-indicator': 'block',
  'typorai-file-indicator': 'none',
  'typorai-image-preview': 'none',
  'typorai-mcp-selector': 'flex',
  'typorai-mode-selector': 'flex',
  'typorai-permission-toggle': 'flex',
  'typorai-selection-indicator': 'block',
  'typorai-service-tier-toggle': 'flex',
  'typorai-status-panel-bash': 'block',
  'typorai-status-panel-bash-content': 'block',
  'typorai-status-panel-bash-entry-content': 'block',
  'typorai-status-panel-content': 'block',
  'typorai-status-panel-todos': 'block',
  'typorai-tab-content': 'flex',
  'typorai-thinking-budget': 'flex',
  'typorai-thinking-effort': 'flex',
};

const DISPLAY_CLASSES = new Set([
  'typorai-hidden',
  'typorai-visible-block',
  'typorai-visible-flex',
...
export function createMockEl(tag = 'div'): any {
  ...
  const resolveDisplay = (): string | null => {
    if (classes.has('typorai-hidden')) return 'none';
    if (classes.has('typorai-visible-flex')) return 'flex';
    if (classes.has('typorai-visible-block')) return 'block';
