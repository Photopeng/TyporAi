...
import { ClaudeCliResolver, resolveClaudeCliPath as resolveClaudeCliPathWithProbe } from '@/providers/claude/runtime/ClaudeCliResolver';
...
describe('resolveClaudeCliPath', () => {
  ...
  it('should pass env PATH to findClaudeCLIPath', () => {
    ...
    expect(mockedFind).toHaveBeenCalledWith('/custom/bin', { fileProbe });
  });
});
