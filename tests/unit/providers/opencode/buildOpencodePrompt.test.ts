...
describe('buildOpencodePromptText', () => {
  it('appends TyporAi XML context to the user query', () => {
  ...
  it('includes the current Typora document snapshot like Claude does', () => {
    const prompt = buildOpencodePromptText({
    ...
    expect(prompt).toContain('<current_typora_document path="C:\\Users\\27758\\Desktop\\demo.md">');
    expect(prompt).toContain('# Demo');
    expect(prompt).toContain('<current_typora_selection>');
