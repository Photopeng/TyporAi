...
describe('CodexAuxQueryRunner', () => {
  ...
  it('passes a host-owned process transport to its ephemeral app-server', async () => {
    const plugin = {
      settings: {},
      getActiveEnvironmentVariables: jest.fn(),
