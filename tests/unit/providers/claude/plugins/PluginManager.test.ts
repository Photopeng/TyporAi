...
import { PluginManager as PluginManagerClass } from '@/providers/claude/plugins/PluginManager';
...
const installedPluginsPath = `${homeDir}/.claude/plugins/installed_plugins.json`;
const globalSettingsPath = `${homeDir}/.claude/settings.json`;
const projectSettingsPath = `${vaultPath}/.claude/settings.json`;
